...
$(window).scroll(function () {
    ...
    if(sct2>=900){
        ...
        $("#pager li:nth-child(2) a").css("background","#ffffff");
    }
    if(sct2>=1800){
        $("#pager li a").css("background","none");
        $("#pager li:nth-child(3) a").css("background","#ffffff");
    }
    if(sct2>=2700){
        $("#pager li a").css("background","none");
        $("#pager li:nth-child(4) a").css("background","#ffffff");
    }
    if(sct2>=3600){
        $("#pager li a").css("background","none");
        $("#pager li:nth-child(5) a").css("background","#ffffff");
    }
    if(sct2>=4500){
        $("#pager li a").css("background","none");
        $("#pager li:nth-child(6) a").css("background","#ffffff");
    }
    if(sct2>=5400){
        $("#pager li a").css("background","none");
        $("#pager li:nth-child(7) a").css("background","#ffffff");
    }
